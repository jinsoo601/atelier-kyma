...
export default function ExhibitionDetail({ exhibitionDetail }: Props) {
	...
	return (
		<>
			...
			<div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-8 md:h-[360px]">
				<Painting
					src="/jiyu/1-1.jpg"
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8 md:h-[360px]">
				<Painting
					src="/jiyu/2-1.jpg"
			...
			<div className="grid grid-cols-1 md:grid-cols-2 my-8 md:h-[360px]">
				<Painting
					src="/jiyu/3-1.jpg"
			...
			<div className="grid grid-cols-1 md:grid-cols-4 my-8 md:h-[360px]">
				<div />
				<div />
				<Painting
					src="/jiyu/5-1.png"
...
export const getStaticProps: GetStaticProps<Props> = async () => {
	const query = `*[_type == "exhibition" && slug.current == "jiyu-kwak-solo-exhibition-layers"][0]{name, startDate, endDate}`;
