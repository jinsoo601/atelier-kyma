		...
		<>
			...
			<div className="grid grid-cols-1 md:grid-cols-6 gap-4 my-12">
				...
				<Painting
					...
					caption={`Draw without drawing 105, 2020, oil bar, oil pastel and acrylic color on canvas 116\n8cm x 91cm`}
				/>
			</div>
			<div className="grid grid-cols-1 md:grid-cols-6 gap-4 my-12">
				<Painting
			...
			<div className="grid grid-cols-1 md:grid-cols-6 gap-4 my-12">
				<Painting
					src="/jeong-hyun-ha-solo-exhibition/5-1.jpeg"
					caption={`Draw without drawing 131, 2022, oil bar, oil pastel and oil color on canvas\n33.4cm x 24.2cm`}
				/>
				<Painting
					src="/jeong-hyun-ha-solo-exhibition/5-2.jpeg"
					caption={`Draw without drawing 132, 2022, oil bar, oil pastel and oil color on canvas\n33.4cm x 24.2cm`}
				/>
				<Painting
